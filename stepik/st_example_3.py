...
# убыванию на основании последнего символа в названии штата

maped_data = list(map(lambda x: (x[1], x[0]), data))
filter_data = sorted(maped_data, key=lambda x: x[0][-1], reverse=True)
